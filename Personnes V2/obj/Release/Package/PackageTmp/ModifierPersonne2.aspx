<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModifierPersonne2.aspx.cs" Inherits="LABO_1.ModifierPersonne2" %>
                    ...
                    <td id="InfoSection">
                        <table>
                           ...
                           <tr>
                            ...
                            <tr>
                                <td>&nbsp;</td>
                                <td><asp:Button ID="BTN_Delete" runat="server" Text="Effacer" class="submitBTN" 
                                    onclientclick="return confirm('Voulez-vous vraiment effacer cet enregistrement?');" 
                            ...
                            <tr>
                                ...
                                <td><asp:Button ID="Button1" runat="server" Text="Annuler" class="submitBTN" 
